<template>
    <div class="container pb-[100px]">
        <div class="w-[100%] pb-7 flex justify-between">
            <h3 class="text-[36px] text-[#000] font-popo font-semibold">Best Selling Products</h3>
            <a href="" class="text-[#FAFAFA] font-popo text-[16px] font-medium bg-[#DB4444] py-4 px-12 rounded">View All</a>
        </div> 
        <div class="flex gap-x-7">
            <div class="w-[25%] relative pb-5" v-for="total in 4" :key="total">
                <div class="bg-[#F5F5F5] rounded-[4px] flex items-center justify-center p-12">
                    <img :src="product" alt="">
                </div>
                <h3 class="text-[16px] font-medium text-[#000] font-popo pt-4">Gucci duffle bag</h3>
...
<script setup>
    import product from '@/assets/images/best.png'
</script>